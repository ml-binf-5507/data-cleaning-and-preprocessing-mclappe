...
1. **What tools did you use?** (e.g., ChatGPT, Claude, GitHub Copilot)
   ...
   _____Copilot____________________________________________________________

2. **What specific things did you ask them to do?** (Be specific)
   
   _____Helped me connect my repository to my VS code____________________________________________________________
...
3. **How much of your final code came from AI vs. your own work?** (e.g., "AI gave me the formula, I wrote the loop" or "AI helped me debug an error")
   ...
   _____No code from AI____________________________________________________________
